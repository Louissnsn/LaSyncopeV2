    ...
    <div className={styles.container}>
      <div className={styles.publicationContainer}>
        <p className={styles.titre}>
          ...
          <br />
          Mathilde BELLIN et Pauline LEGÖEDEC
        </p>
      </div>
      <div className={styles.droits}>
        ...
        <span className={styles.texte}>
          L&apos;ensemble des éléments composant ce site, œuvre protégée par la
          législation sur la propriété intellectuelle, sont la propriété
